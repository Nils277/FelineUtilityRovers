...
{
    public class ModuleKerbetrotterHoverEngine : PartModule, IThrustProvider
    {
        /// <summary>
        ...
        public override void OnStart(PartModule.StartState state)
        {
            ...
            velocityCurve = stringToFloatCurve(velocityLimit);
            atmosphericThrustCurve = stringToFloatCurve(atmosphericThrust);
            fuelConsumptionCurve = stringToFloatCurve(fuelConsumption);
            throttleThrustCurve = stringToFloatCurve(throttleThrust);
        ...
        protected virtual double consumeResources()
        {
            ...
            if (EngineIgnited)
            {
                for (int i = 0; i < resourceList.Count; i++)
                {
                    ...
                    resourceList[i].currentSupply = Clamp(fuelReceived / requestFuelAmount, 0d, 1d);
